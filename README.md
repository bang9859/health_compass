...
### 🥝방서준 
이번 팀 프로젝트에서 처음으로 팀장을 맡아 A부터 Z까지 프로젝트를 주도하며 진행했습니다. 처음에는 끝이 보이지 않는 막막함에 힘들었지만, 팀원들과 소통하며 하나씩 해결해 나가면서 점차 자신감을 가질 수 있었습니다.

특히, 아이디어 회의부터 개발까지 전 과정에서 소통이 중요하다는 점을 절실히 깨달았습니다. 프로젝트를 이끌면서 모든 결정을 혼자 내리는 것이 아니라, 팀원들과 충분한 논의를 거쳐 최선의 선택을 하는 것이 중요했습니다. 적극적인 의견 교환을 통해 더 나은 방향으로 나아갈 수 있었고, 이는 프로젝트의 완성도를 높이는 데 큰 도움이 되었습니다.

또한, 초반에 화면 구성을 좀 더 신경 써야 한다는 점도 배웠습니다. 처음부터 버튼 위치나 페이지 이동 흐름 같은 요소를 꼼꼼히 정리하면, 개발 중간에 불필요한 수정 작업이 줄어든다는 걸 깨달았습니다. 다음 프로젝트에서는 초반에 화면 설계를 더 탄탄하게 해서, 개발 과정에서 시행착오를 최소화하고 싶습니다.

마지막으로, 팀장으로서 발표를 준비하고 진행하는 과정이 가장 도전적인 경험이었습니다. 긴장도 많이 됐지만, 듣는 사람과 시선을 맞추며 전달하려고 노력했습니다. 이번 프로젝트를 통해 개발뿐만 아니라 발표와 소통 능력까지 성장할 수 있었습니다.

비록 쉽지 않은 과정이었지만, 너무나 값진 경험이었고 개발자로서 한 걸음 더 나아갈 수 있었습니다. 앞으로도 협업과 소통을 중요하게 여기며 더 성장해 나가고 싶습니다! 🚀
### 🍋 박현균
처음으로 팀 프로젝트를 진행하면서 '과연 내가 이걸 완성할 수 있을까?' 하는 걱정과 두려움이 컸습니다. 하지만 직접 개발을 진행하며 하나씩 문제를 해결해 나가면서, 점점 더 프로젝트에 대한 자신감이 생겼습니다.

처음 설계했던 대로 개발이 진행되지 않는 경우가 많았고, 예상치 못한 문제도 계속해서 발생했습니다. 하지만 진행 과정에서 유연하게 계획을 수정하고, 필요에 따라 기능을 추가하거나 제거하며 점점 더 나은 결과물을 만들어낼 수 있었습니다.
결과적으로 처음 구상했던 것보다 더 완성도 높은 프로젝트를 만들 수 있었고, 계획은 변경될 수 있지만 발전을 위한 과정이라는 점을 배울 수 있었습니다.

이 프로젝트를 통해 팀원들과의 소통이 얼마나 중요한지도 몸소 경험했습니다.
각자가 맡은 역할을 수행하면서도 서로의 의견을 공유하고 피드백을 주고받으면서, 개인 프로젝트와는 차원이 다른 경험을 할 수 있었습니다.
혼자 개발할 때는 보지 못했던 다양한 관점에서 문제를 바라보는 법을 배웠고, 팀원들의 의견을 반영하며 더 나은 설계를 고민하는 과정이 큰 성장의 기회가 되었습니다.

무엇보다도, 이번 프로젝트를 통해 기술적인 성장뿐만 아니라 협업의 중요성, 문제 해결 능력, 그리고 유연한 사고 방식을 배울 수 있었습니다.
이 경험은 앞으로 더 큰 프로젝트를 진행할 때 확실한 밑바탕이 될 것이라 확신합니다.
앞으로도 계속해서 도전하고 배우며 더 나은 개발자로 성장할 수 있도록 노력하겠습니다!
### 🍈 이준호
ㅤ지난 한 달 동안 진행한 팀 프로젝트를 통해 초기 설계가 얼마나 중요한지 몸소 깨달았습니다. 처음으로 팀 단위로 서비스를 구축해보면서 완벽한 설계를 기대했지만,
ERD나 테이블 설계 단계에서 몇 가지 중요한 요소들이 빠지거나 미흡한 부분이 드러나 처음부터 다시 수정해야 하는 상황이 잦았습니다.
게다가, 설계를 마친 후 개발을 시작하더라도 계획과는 다소 다른 방향으로 진행되는 경우가 있어, 개발과 수정 작업이 반복되면서 예상보다 훨씬 많은 시간이 소요되었습니다.<br>
ㅤ이번 경험을 통해 초기 설계가 프로젝트 전체의 진행과 개발 기간에 큰 영향을 미친다는 점을 다시 한 번 느낄 수 있었습니다.
앞으로의 프로젝트에서는 초기 설계 단계에 더욱 신중을 기해, 오류나 개선할 부분이 없는지 꼼꼼히 검토할 필요가 있다고 생각합니다.
또한, 팀원들이 각자 맡은 기능들이 하나로 모여 문제없이 작동할 때의 성취감과 개발의 재미를 경험하면서, 팀워크와 협업의 중요성을 다시 한 번 실감하게 되었습니다.<br>
ㅤ이번 과정을 통해 팀원 간의 의견 공유와 활발한 피드백 문화가 프로젝트 성공에 얼마나 중요한 역할을 하는지 새삼 깨달았습니다.
앞으로의 프로젝트에서 팀워크를 강화하고 원활한 소통을 통해 성공적인 결과를 도출하는 데 좋은 경험이 된 프로젝트였습니다.<br>
